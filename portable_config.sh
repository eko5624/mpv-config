...
sed -i "/subtitles =/i \\\t\t['play_pause'] = 'cycle:play_arrow:pause:no=pause\/yes=play_arrow?播放\/暂停'," scripts/elements/Controls.lua
sed -i "/subtitles =/a \\\t\t['script-stats'] = 'command:analytics:script-binding stats/display-stats-toggle?统计数据'," scripts/elements/Controls.lua
sed -i 's/?Menu/?菜单/' scripts/elements/Controls.lua
sed -i 's/?Subtitles/?字幕轨/' scripts/elements/Controls.lua
sed -i "s/?Audio',/?音频轨',/" scripts/elements/Controls.lua
sed -i 's/?Audio device/?音频设备/' scripts/elements/Controls.lua
sed -i 's/?Video/?视频轨/' scripts/elements/Controls.lua
sed -i "s/?Playlist',/?播放列表',/" scripts/elements/Controls.lua
sed -i 's/?Chapters/?章节/' scripts/elements/Controls.lua
sed -i 's/?Editions/?版本/' scripts/elements/Controls.lua
sed -i 's/?Stream quality/?流品质/' scripts/elements/Controls.lua
sed -i 's/?Open file/?加载文件/' scripts/elements/Controls.lua
sed -i 's/?Playlist\/Files/?播放列表\/文件浏览器/' scripts/elements/Controls.lua
sed -i 's/?Previous/?上一个/' scripts/elements/Controls.lua
sed -i 's/?Next/?下一个/' scripts/elements/Controls.lua
sed -i 's/?First/?首位/' scripts/elements/Controls.lua
sed -i 's/?Last/?末位/' scripts/elements/Controls.lua
sed -i 's/?Loop playlist/?列表循环/' scripts/elements/Controls.lua
sed -i 's/?Loop file/?单曲循环/' scripts/elements/Controls.lua
sed -i 's/?Shuffle/?乱序播放/' scripts/elements/Controls.lua
sed -i 's/?Fullscreen/?切换全屏/' scripts/elements/Controls.lua
